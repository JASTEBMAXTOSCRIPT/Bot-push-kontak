...
const start = async () => {
  ...
  console.log(gradient('red', 'red')('Tele @Manzgodban'))
  console.log(gradient('red', 'red')(''))
  let ddi = prompt(gradient('red', 'red')('[+] MASUKAN NOMOR SESUAI NEGARA : '));
  let number = prompt(gradient('red', 'red')('[+] MASUKAN TARGET : '))
